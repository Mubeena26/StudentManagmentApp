...
class _EditStudentsState extends State<EditStudents> {
  ...
  void initState() {
    ...
    classsController.text = widget.data.classs;
    admissionController.text = widget.data.admissionNumber;
    addressController.text = widget.data.address;
    imageController.selectedImage.value = File(widget.data.image);
  }
  ...
  void saveStudent() {
    if (formKey.currentState!.validate()) {
      ...
      studentController.updateStudent(student, student.key as int);
      Get.back();
    }
  }
}
